...
const orderProduct = new Order(12345);

const productOne = new Product("Phone", 500, 2);
orderProduct.addProduct(productOne);

const productTwo = new Product("Headphones", 100, 1);
orderProduct.addProduct(productTwo);

console.log(orderProduct.getTotalPrice()); // Вывод: 1100